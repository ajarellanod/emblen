# Generated by Django 3.1.3 on 2021-02-23 18:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo_beneficiario', models.IntegerField(choices=[(0, 'Femenino'), (1, 'Masculino'), (2, 'No Definido')], default=2, verbose_name='Sexo del Beneficiario')),
                ...
                ('ejecutado_anio_anterior', models.DecimalField(decimal_places=2, max_digits=22)),
                ('estimado_anio_siguiente', models.DecimalField(decimal_places=2, max_digits=22)),
                ('estimado_anio_ejercicio', models.DecimalField(decimal_places=2, max_digits=22)),
